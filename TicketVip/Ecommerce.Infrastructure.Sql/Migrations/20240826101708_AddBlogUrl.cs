        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Enđate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPortfolioCategoryId = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioCategorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PortfolioCategorys_PortfolioCategorys_ParentPortfolioCategoryId",
                        column: x => x.ParentPortfolioCategoryId,
                        principalTable: "PortfolioCategorys",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoiTac = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MaDonHang = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    SanphamDichvu = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    TongNguoiLons = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TongTreEms = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioCategorys_ParentPortfolioCategoryId",
                table: "PortfolioCategorys",
                column: "ParentPortfolioCategoryId");
        }
