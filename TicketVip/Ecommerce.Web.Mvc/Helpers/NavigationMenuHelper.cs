...
public class NavigationMenuHelper
{
    public List<NavMenu> NavMenuBuilder()
    {
        ...
        navmenu.Add(new NavMenu { Id = 33, ParentMenuId = null, Name = "Tạo vé", Key = Permissions.Permissions_QR_View, ControllerName = "QR", ActionName = "CreateQR", IsActive = true, IsVisible = true, MenuIcon = "fas fa-envelope-open-text" });
        navmenu.Add(new NavMenu { Id = 34, ParentMenuId = null, Name = "Thông tin đối tác", Key = Permissions.Permissions_PortfolioCategory_View, ControllerName = "PortfolioCategory", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-envelope-open-text" });
